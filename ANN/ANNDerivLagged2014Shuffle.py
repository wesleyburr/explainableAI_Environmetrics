...
# Write the data out...
df3.to_csv("Plots/ANNDerivRAWFeb_to_May_RatioShuffle.csv", index = False)
...
plt.xlabel('Lon')
plt.ylabel('Lat')
plt.title('February to May (RAW) Feature Shuffle')
#os.chdir("/Volumes/GoogleDrive/My Drive/Research/Working Group /SoilMoistureExample")
plt.savefig('Plots/Pred_Feb_to_May_RatioShuffle.png', format = 'png')#, quality = 100)
plt.show()
